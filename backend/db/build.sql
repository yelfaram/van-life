...
INSERT INTO 
  van (owner_id, name, price, description, type) 
VALUES
  ...
  (2, 'Reliable Red', 100, 'Reliable Red is a van that was made for travelling. The inside is comfortable and cozy, with plenty of space to stretch out in. There''s a small kitchen, so you can cook if you need to. You''ll feel like home as soon as you step out of it.', 'luxury'),
  (3, 'Dreamfinder', 65, 'Dreamfinder is the perfect van to travel in and experience. With a ceiling height of 2.1m, you can stand up in this van and there is great head room. The floor is a beautiful glass-reinforced plastic (GRP) which is easy to clean and very hard wearing. A large rear window and large side windows make it really light inside and keep it well ventilated.', 'simple'),
  (3, 'The Cruiser', 120, 'The Cruiser is a van for those who love to travel in comfort and luxury. With its many windows, spacious interior and ample storage space, the Cruiser offers a beautiful view wherever you go.', 'luxury');
